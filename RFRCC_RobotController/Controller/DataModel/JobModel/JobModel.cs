...
namespace RFRCC_RobotController.Controller.DataModel
{
    ...
    public class JobModel
    {
        ...
        /// </summary>
        public IJobModelTemplate Template { get; set; } = new DefaultJobTemplate();
        /// <summary>
        ...
        public JobModel(IJobModelTemplate template = null)
        {
            if (template != null)
            {
                Template = template;
        ...
        public JobModel(RobotController ParentController, IJobModelTemplate template = null) : this(template)
        {
        ...
        /// NOT YET IMPLEMENTED
        /// </summary>
        public void Abort(AbortCode Code = 0)
        {
            ...
            Status.Aborting();
            // Call Robot To abort
            _parentController.RobotProcess.AbortJob(Code);
            // call job to implement all new tasks
            Template.AbortJob(this);
        ...
        public bool ConnectAllJobEvents()
        {
            if (_controllerPresent)
            {
                ...
                operationActions.CallForRobotProcess -= _parentController.RobotProcess.CallForProcessHandler;
                operationActions.CallForRobotProcess += _parentController.RobotProcess.CallForProcessHandler;
                return true;
            }
            else
        ...
        public bool ConnectToController()
        {
            ...
            ConnectAllJobEvents(); // TODO: this will be a problem, need to have some kind of control over when this connects
            return true;
        }
        // TODO: discriptive summary comment
        ...
        {
            JobAborted?.Invoke(this, new EventArgs());
        }
