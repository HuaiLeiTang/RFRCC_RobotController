...
using RobTarget = ReplaceRSConnection.Robotics.RobTarget;
using System.Linq;
...
namespace RFARCC_RobotController.RCC_RobotController
{
    ...
    public class OperationHeader
    {
        ...
        public override string ToString()
        {
            return "[" +
               ...
               _PathComplete.ToString().ToUpper() + "," +
               _Ready.ToString().ToUpper() + "," +
               _LeadInstruction.ToString().ToUpper() + "," +
               _Complete.ToString().ToUpper() + "]";
        }
    ...
    public class CS_pos
    {
        ...
        public static CS_pos operator *(CS_pos a, int b)
           => new CS_pos(a.X * b, a.Y * b, a.Z * b);
